...
channel_stacks = pd.read_csv('/Users/mainguyen/Downloads/Assessment 2-3/CW2/conversion-path.csv')

#Calculate average conversion
# Read the data
data = pd.read_csv('/Users/mainguyen/Downloads/Assessment 2-3/CW2/attribution data.csv')
